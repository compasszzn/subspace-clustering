...
from method.EDSC_wo import EDSC_wo
import numpy as np
...
if __name__ == '__main__':
    ...
    edsc = EDSC_wo(n_clusters=N_CLASSES, regu_coef=REG_Coef_, n_neighbors=NEIGHBORING_, ro=RO_, save_affinity=False)
