...
from method.LRR_w import LRR_w
import numpy as np
...
if __name__ == '__main__':
    ...
    edsc = LRR_w(n_clusters=N_CLASSES, regu_coef=REG_Coef_, n_neighbors=NEIGHBORING_, ro=RO_, save_affinity=False)
